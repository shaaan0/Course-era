...
class Contact extends React.Component {
    ...
    handleSubmit(event) {
        ...
        alert('Current State is: ' + JSON.stringinfy(this.state));
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="ss"><i className="fa fa-skype"></i> Skype</a>
